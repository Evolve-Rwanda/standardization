...
public class ColumnMarkupElement {
    ...
    public ColumnMarkupElement(String columnId, String tagName, String typeAttributeValue, String nameAttributeValue, boolean isMutuallyExclusive) {
